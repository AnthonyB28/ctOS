...
(function (AlanBBOS) {
    var CanvasTextFunctions = (function () {
        ...
        CanvasTextFunctions.prototype.letter = function (ch) {
            return this.letters[ch];
        };

        CanvasTextFunctions.prototype.ascent = function (font, size) {
            return size;
        };

        CanvasTextFunctions.prototype.descent = function (font, size) {
            return 7.0 * size / 25.0;
        };

        CanvasTextFunctions.prototype.measure = function (font, size, str) {
            var total = 0;
            var len = str.length;
        ...
        CanvasTextFunctions.prototype.draw = function (ctx, font, size, x, y, str) {
            var total = 0;
            var len = str.length;
            var mag = size / 25.0;
        ...
        CanvasTextFunctions.enable = function (ctx) {
            ...
            ctx.measureText = function (font, size, text) {
                return this.measure(font, size, text);
            };
            ctx.fontAscent = function (font, size) {
                return this.ascent(font, size);
            };
            ctx.fontDescent = function (font, size) {
                return this.descent(font, size);
            };
